...
- Download the latest release from [here](https://github.com/mkathuri/kiwings/releases/download/1.0-beta3/Kiwings-1.0-beta3.dmg) (currently in beta).
...
- Detecting button if button is pressed (read: pressed and held) in SwiftUI: https://stackoverflow.com/a/70191752/4385319
